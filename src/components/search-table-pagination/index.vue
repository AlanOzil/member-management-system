...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleCurrentChange (pageIdenx) {
        this.pagination.pageIndex = pageIdenx;
        this.dataChangeHandler();
      },
      ...
      fetchHandler (formParams = {}) {
        this.loading = true;
        let { fetch, method, url, $axios, headers, listField, pageIndexKey, pageSizeKey,
        ...
        if (showPagination) {
          params = Object.assign(params, {
            ...
            [pageIndexKey]: pagination.pageSize
          })
        }
    ...
    mounted () {
      ...
      this.$refs['table'].$on('toggleRowSelection', row => console.log(row));
