...
var sqlMap = {
  ...
  dicItem: {
    getItemList: 'select item_id as id, null as parent, text, code, seq as orderSort, b.name as createdBy, a.created_time as createdTime, description, a.status from sys_dictionaryitems as a left join sys_user as b on a.created_by = b.id where a.status = 1 and a.is_deleted = 0 and a.dictionary_id= ? order by a.seq asc limit ?,?;',
